...
export class ClientesComponent implements OnInit {
  ...
  clientes: Cliente[] = [
    ...
    { id: 3, nombre: 'Linux', apellido: 'Torvalds', email: 'linux.torvals@gmail.com', createAt: '2018-01-03' },
    { id: 4, nombre: 'Rasmus', apellido: 'Lerdorff', email: 'rasmus.lerdorff@gmail.com', createAt: '2018-01-04' },
    ...
    { id: 7, nombre: 'Ralf', apellido: 'Johnson', email: 'ralf.johson@gmail.com', createAt: '2018-02-18' },
    { id: 8, nombre: 'John', apellido: 'Vlissides', email: 'john.vlissides@gmail.com', createAt: '2018-02-28' },
    { id: 9, nombre: 'James', apellido: 'Gosling', email: 'james.gosling@gmail.com', createAt: '2018-03-03' },
    ...
    { id: 12, nombre: 'Jade', apellido: 'Doe', email: 'jade.doe@gmail.com', createAt: '2018-03-06' },
  ];
